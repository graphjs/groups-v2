...
<html>
	<head>
		...
		<!-- Components -->
		<link rel="stylesheet" type="text/css" href="/site/styles/components.css" />
	...
	<body>
		<!-- Navigation -->
		<nav class="groups-navigation navbar navbar-dark navbar-expand-md fixed-top">
    ...
    <footer class="groups-footer footer mt-auto">
	      ...
	      <div class="row">
	        <div class="col-md-3 d-none d-md-block">
	          <a class="text-muted" href="#">&copy; 2018 GROU.PS, Inc.</a>
	        </div>
